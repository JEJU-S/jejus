    ...
    (function () {
        const slideList = document.querySelector('.slide-list');  // Slide parent dom
        const slideContents = document.querySelectorAll('.slide-content');  // each slide dom
        const slideBtnNext = document.querySelector('.slide-btn-next'); // next button
        const slideBtnPrev = document.querySelector('.slide-btn-prev'); // prev button
        const pagination = document.querySelector('.slide-pagination');
        const slideLen = slideContents.length;  // slide length
        const slideWidth = 1130; // slide width
